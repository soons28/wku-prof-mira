document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        zh: {
            site_title: "金美羅 教授 - 圆光大学韩中关系研究院",
            site_description: "圆光大学韩中关系研究院 金美羅 教授 官方网站。介绍中国古典散文、文学批评及韩中比较文学的研究成果。",
            wku_name: "圆光大学",
            ...
            pub_book_1_info: "金美羅, 洪起用 合译 | Dareun Saenggak | 2011.",
        ...
        ja: {
            site_title: "金美羅 教授 - 円光大学校韓中関係研究院",
            site_description: "円光大学校韓中関係研究院 金美羅 教授 公式ウェブサイト。中国古典散文、文学批評、韓中比較文学の研究成果を紹介します。",
            wku_name: "円光大学",
            ...
            prof_name: "金美羅",
            prof_title_suffix: "教授",
            hero_desc: "円光大学校韓中関係研究院で中国古典文学を研究し、伝統の深みと現代の視点を結ぶ学術的な架け橋としての役割を担っています。",
            hero_btn_research: "研究を見る",
            hero_btn_contact: "お問い合わせ",
            prof_img_alt: "金美羅 教授 ポートレート",
            section_about_badge: "ABOUT",
            ...
            pub_book_1_info: "金美羅, 洪起用 共訳 | Dareun Saenggak | 2011.",
